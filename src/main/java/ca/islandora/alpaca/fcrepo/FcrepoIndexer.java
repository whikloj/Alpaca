...
import ca.islandora.alpaca.exceptions.MissingJsonUrlException;
...
public class FcrepoIndexer extends RouteBuilder {
    ...
    private final FcrepoIndexerOptions fcrepoConfig;
    ...
    public FcrepoIndexer(
            final FcrepoIndexerOptions fcrepoConfig,
            final AlpacaConfig alpacaConfig) {
        this.fcrepoConfig = fcrepoConfig;
    ...
    public void configure() {
        ...
        final Processor commonProcessor = new CommonProcessor(fcrepoConfig);
        ...
        from(fcrepoConfig.getNodeIndex())
        ...
        from(fcrepoConfig.getNodeDelete())
        ...
        from(fcrepoConfig.getMediaIndex())
        ...
        from(fcrepoConfig.getExternalIndex())
    ...
    private String makeMillinerUri(final String uriPart) {
        return alpacaConfig.addHttpOptions(fcrepoConfig.getMillinerBaseUrl() + uriPart);
    }
}
