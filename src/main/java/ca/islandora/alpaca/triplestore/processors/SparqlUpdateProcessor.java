 ...
 */
package ca.islandora.alpaca.triplestore.processors;

import static ca.islandora.alpaca.triplestore.processors.FcrepoHeaders.FCREPO_NAMED_GRAPH;
import static ca.islandora.alpaca.triplestore.processors.ProcessorUtils.deleteWhere;
import static ca.islandora.alpaca.triplestore.processors.ProcessorUtils.getSubjectUri;
import static ca.islandora.alpaca.triplestore.processors.ProcessorUtils.insertData;
...
public class SparqlUpdateProcessor implements Processor {
    ...
    public void process(final Exchange exchange) throws IOException, NoSuchHeaderException {
        ...
        in.setBody("update=" + encode(deleteWhere(subject, namedGraph) + ";\n" +
                insertData(serializedGraph.toString(UTF_8), namedGraph), UTF_8));
